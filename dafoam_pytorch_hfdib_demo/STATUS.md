...
| G | static HFDIB obstacle | **G1 physical PASS, G2 delta-JTV partial (U/p exact, U/U ~2e-3, U/phi ~16%)** — HFDIB source physically correct and on AD tape for U/p paths; phi-coupling derivative has the same baseline far-field issue. Network-parameter gradient check is the decisive test. |
