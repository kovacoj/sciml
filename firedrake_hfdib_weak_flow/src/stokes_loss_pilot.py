...
class Loss:
    def __init__(self, name: str, operator, residual0, norm):
        self.name = name
        self.A = operator
        self.r0 = residual0
        self.X = norm
...
def run(nx: int, ny: int, output: Path, maxiter: int = 300) -> dict:
...
def main() -> None:
    ...
    run(arguments.nx, arguments.ny, arguments.output, arguments.maxiter)
