...
The source collection currently includes the Laplacian demonstration and a thermodynamic linear algebra gallery example. The Laplacian notebook is also exported as a standalone application; both examples are presented as native marimo cells in Fumadocs.
