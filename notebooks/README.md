...
The source collection includes the Laplacian demonstration, the precomputed harmonic-oscillator comparison, and a thermodynamic linear algebra gallery example. The Laplacian and harmonic-oscillator notebooks are exported as standalone applications; the experiments are also presented as native marimo cells in Fumadocs.
